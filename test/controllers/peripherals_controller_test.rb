...
class PeripheralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peripheral" do
    assert_difference("Peripheral.count") do
      post peripherals_url, params: { peripheral: { brand: @peripheral.brand, colaborator_id: @peripheral.colaborator_id, description: @peripheral.description, headquarter_id: @peripheral.headquarter_id, model: @peripheral.model, serial: @peripheral.serial, type_id: @peripheral.type_id } }
    end
  ...
  test "should update peripheral" do
    patch peripheral_url(@peripheral), params: { peripheral: { brand: @peripheral.brand, colaborator_id: @peripheral.colaborator_id, description: @peripheral.description, headquarter_id: @peripheral.headquarter_id, model: @peripheral.model, serial: @peripheral.serial, type_id: @peripheral.type_id } }
